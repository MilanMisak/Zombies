...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.last_action'
        db.add_column('game_game', 'last_action',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Game.last_direction'
        db.add_column('game_game', 'last_direction',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.last_action'
        db.delete_column('game_game', 'last_action')

        # Deleting field 'Game.last_direction'
        db.delete_column('game_game', 'last_direction')
