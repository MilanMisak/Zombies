...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeaderboardEntry'
        db.create_table('game_leaderboardentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('score', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('game', ['LeaderboardEntry'])


    def backwards(self, orm):
        # Deleting model 'LeaderboardEntry'
        db.delete_table('game_leaderboardentry')
