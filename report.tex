...
We chose to write the front end in Javascript, obviously, and we chose to use this as a basis for the graphics also. Instead of using flash or a java applet. This is because unlike the previous 2 choices, HTML5 will load faster and it is a new technology which will continue to be supported by browsers for some time. People are already talking about stopping flash support, on mobile devices in particular.

We chose to use Django for the back end because some of us have previous experience using the platform, TODO - Milan: write more.
...
We used twitter bootstrap CSS, Javascript, and some glyph icons for the website layout. We also used some Javascript libraries: Jquery and Paper.js, for simplification and for working with the HTML5 canvas. TODO: Do we acknowledge Django? All of the artwork within the canvas is original.

\section{Conclusion}
TODO: In conclusion, we are the best.
